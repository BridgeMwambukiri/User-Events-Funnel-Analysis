-- User Events Funnel Analysis Project
-- Author: Bridge Mwambukiri
-- Tools: Google BigQuery, SQL
-- Goal: Analyze conversion rates, traffic sources,
-- revenue metrics, and user purchasing behavior

SELECT * FROM `project-6824f999-e123-4f28-a0a.SQLpractice1.User Events` LIMIT 1000;
...
WITH funnel_stages AS (
  ...
  FROM `project-6824f999-e123-4f28-a0a.SQLpractice1.User Events`

  WHERE event_date >= '2025-12-01'   -- covers my actual data range
